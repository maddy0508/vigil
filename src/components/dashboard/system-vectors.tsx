...
const vectors = [
    ...
    { name: "Wireless USB", icon: <Usb className="h-5 w-5 text-foreground" />, status: "Monitored", color: "text-green-400" },
    { name: "Bluetooth", icon: <Bluetooth className="h-5 w-5 text-foreground" />, status: "Monitored", color: "text-green-400" },
    { name: "System Drivers", icon: <HardDrive className="h-5 w-5 text-foreground" />, status: "Monitored", color: "text-green-400" },
    { name: "Nearby Devices (WiFi)", icon: <Wifi className="h-5 w-5 text-foreground" />, status: "Monitored", color: "text-green-400" },
